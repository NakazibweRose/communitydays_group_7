# Psychology App — Group 7

**ODE Community Days 2026, Kampala**

Register reflection journals, open their details, and select **Add a reflection** to save a linked follow-up. Both forms ask only three questions.
...
- `forms/group_7_registration/`: registration schema and layout.
- `forms/group_7_followup/`: follow-up schema and layout.
...
1. Install the bundle in Formulus/Desktop and register two fictional reflection journals.
2. Close each saved form: the table should update without pressing Refresh. Cancel a third form: no draft should appear.
3. Open the first row, select **Add a reflection**, and save. Its history should update; the second row must not show that follow-up.
