# Psychology — Group 7: agent and developer guide
...
- **Theme:** Psychology.
- **Register:** reflection journal (`group_7_registration`).
- **Follow-up action:** Add a reflection (`group_7_followup`).
...
| Registration questions | `forms/group_7_registration/schema.json` and `ui.json` |
| Follow-up questions | `forms/group_7_followup/schema.json` and `ui.json` |
